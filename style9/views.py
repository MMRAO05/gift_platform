...
class CreatePageView(View):
    """Serves the original 9.html page unchanged (setup + reveal
    in one template, exactly like the source file)."""

    def get(self, request):
        return render(request, "style9/page.html")
...
class RevealSeedView(View):
    """/style9/g/<short_code>/  — looks the gift up, then serves a tiny page
    ...
    def get(self, request, short_code):
        ...
        gift.register_view()
        return render(request, "style9/seed_redirect.html", {
