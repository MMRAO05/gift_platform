...
class CreatePageView(View):
    """Serves the original 6.html page unchanged (setup + reveal
    in one template, exactly like the source file)."""

    def get(self, request):
        return render(request, "style6/page.html")
...
class RevealSeedView(View):
    """/style6/g/<short_code>/  — looks the gift up, then serves a tiny page
    ...
    def get(self, request, short_code):
        ...
        gift.register_view()
        return render(request, "style6/seed_redirect.html", {
